        ...
        <div className="flex justify-center items-center w-4/12">
            ...
            <div className="m-0 p-0 h-auto w-7/12 mt-2">
                ...
                <div className="flex items-center justify-center mt-4">
                    <button type="submit" className="border-2 border-teal-700 bg-teal-700 w-1/4 p-1 rounded-md hover:bg-teal-800 hover:border-teal-800"><Link href="/">Submit</Link></button>
                </div> 
                </form>
